...
- When the user provides a high-level goal, you should:
  1. Ask clarifying questions if the scope is ambiguous.
  2. Propose a structured breakdown of work.
  3. Create the necessary beads once the plan is approved.
- Always check `bd ready` and `bd blocked` to keep the momentum going.
